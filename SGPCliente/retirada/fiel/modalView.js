        ...
        <Modal size="xl" isOpen={this.state.modal} >
                  ...
                  <Form>
                    ...
                    <Col xs="4">
                      <FormGroup>
                        <Label>Nome</Label>
                        <Input  disabled type="text" placeholder="Digite Seu Nome." value={fiels.nome}/>
                      </FormGroup>
                    </Col>
                    <Col xs="2">
                      <FormGroup>
                        <Label>Data de Nascimento</Label>
                        <Input disabled type="text" placeholder="__/___/___"/>
                      </FormGroup>
                    </Col>
                    <Col>
                      <FormGroup>
                    ...
                    <Col xs="2">
                      <FormGroup>
                        ...
                        <Input  disabled type="number" placeholder="Digite seu telefone"/>
                      </FormGroup>
                    </Col>
                    <Col xs="2">
                      <FormGroup>
                        <Label>Celular</Label>
                        <Input disabled type="number" placeholder="Digite o seu celular."/>
                      </FormGroup>
                    </Col>
                    </Row>
                    <Row>
